...
<body class="font-sans bg-gray-100">
    ...
    <header class="p-5 border-b bg-white shadow flex justify-between items-center">
        ...
        @guest
            <nav class="flex gap-2 items-center">
                <a class="font-bold text-gray-700 hover:text-gray-800" href="{{ route('login') }}"> Login </a>
                <a class="font-bold text-gray-700 hover:text-gray-800" href="{{ route('register') }}"> Registrar </a>
            </nav>
        @endguest
    </header>
